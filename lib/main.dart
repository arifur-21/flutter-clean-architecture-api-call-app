...
import 'package:flutter_final_clean_archi_bloc_api_app/presentation/bloc/login_bloc/login_bloc.dart';
import 'package:flutter_final_clean_archi_bloc_api_app/utils/routes/routes.dart';
...
void serviceLocator(){
  //bloc
  getIt.registerFactory(() => LoginBloc(createPostUseCase: getIt()));
  //use case
  getIt.registerLazySingleton(()=> CreatePostUseCase(getIt()) );
  //repository
  getIt.registerLazySingleton<UserRepository>(()=> PostRepositoryImpl(getIt()));
  ///data source
